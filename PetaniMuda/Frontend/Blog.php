...
<div class="offcanvas offcanvas-end" tabindex="-1" id="cartOffcanvas">
  ...
  <section id="blog" class="py-5">
    <div class="container">
      <h2 class="text-center fw-bold mb-5 mt-5">Artikel & Berita Terbaru</h2>
      <div class="row g-4">
        ...
        ?>
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 shadow-sm border-0">
              <img src="../admin/uploads/blog/<?= htmlspecialchars($b['image']); ?>" 
                   class="card-img-top" 
                   style="height:200px;object-fit:cover;" 
                   alt="<?= htmlspecialchars($b['title']); ?>">
              <div class="card-body d-flex flex-column">
                <h5 class="card-title fw-semibold"><?= htmlspecialchars($b['title']); ?></h5>
                <p class="card-text text-secondary small flex-grow-1">
                  <?= substr(strip_tags($b['content']), 0, 100); ?>...
                </p>
                <div class="mt-auto d-flex justify-content-between align-items-center">
                  <span class="text-muted small">
                    <i class="bi bi-calendar3"></i> <?= date('d M Y', strtotime($b['created_at'])); ?>
                  </span>
                  <a href="detail_blog.php?id=<?= $b['id']; ?>" class="btn btn-success btn-sm">
                    Baca Selengkapnya
                  </a>
                </div>
              </div>
        ...
        <?php
          ...
          echo "<div class='text-center text-muted py-5'>Belum ada artikel yang dipublikasikan.</div>";
        }
        ?>
      </div>
    </div>
