...
<div class="offcanvas offcanvas-end" tabindex="-1" id="cartOffcanvas">
  ...
  <div class="container">
    <h2 class="text-center mt-5 fw-bold">Kontak Kami</h2>
    <div class="row g-4">
      ...
      <div class="col-lg-5">
        <div class="mb-4">
          ...
          <p>Jika ada pertanyaan seputar pemeliharaan, produk, atau kerjasama, silakan hubungi kami melalui form atau informasi berikut:</p>
        </div>
        <ul class="list-unstyled">
          <li class="mb-3"><i class="bi bi-geo-alt-fill me-2 text-success"></i> Cibunut, Majalengka</li>
          <li class="mb-3"><i class="bi bi-envelope-fill me-2 text-success"></i> support@petanimuda.com</li>
          <li class="mb-3"><i class="bi bi-telephone-fill me-2 text-success"></i> +62 857-2398-3187</li>
        </ul>

        <div class="mt-4">
          <a href="#" class="text-success fs-4 me-3"><i class="bi bi-facebook"></i></a>
          <a href="#" class="text-success fs-4 me-3"><i class="bi bi-instagram"></i></a>
      ...
      <!-- Form Kontak -->
      <div class="col-lg-7">
        <form class="contact-form p-4 shadow-sm bg-white rounded">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="subject" placeholder="Judul pesan">
          </div>
          <div class="mb-3">
